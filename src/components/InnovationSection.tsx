...
export const InnovationSection: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 bg-gradient-to-b from-slate-50 to-white rounded-3xl my-8 border border-slate-100">
      {/* Header */}
