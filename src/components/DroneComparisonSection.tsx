...
export const DroneComparisonSection: React.FC<DroneComparisonSectionProps> = ({ onSelectProduct }) => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 my-8 bg-gradient-to-b from-white to-slate-50 rounded-3xl border border-slate-200/80">
      {/* Section Header */}
        ...
        {[
          ...
          return (
            <button
              ...
              className={`px-4 py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all duration-300 inline-flex items-center space-x-2 cursor-pointer ${
                selectedSpec === tab.id
